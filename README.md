...
主に個人で利用することを想定して作成しました。面倒なサーバ管理やデータベースのバックアップに煩わされることなく、無料で運用できます。屋外でも在庫状況を参照できます。
...
- セットアップで作成したGitHub PagesのURL（`https://あなたのユーザー名.github.io/ePartsDB/`）にアクセス
